...
8. 아래 프롬프트를 복사한 후, Kiro 바이브 세션에 입력하여 HTML 검토 및 수정을 요청합니다.
...
10. 아래 프롬프트를 복사한 후, Kiro 바이브 세션에 입력하여 CSS 검토 및 수정을 요청합니다.
```md copy
...
12. 아래 프롬프트를 복사한 후, Kiro 바이브 세션에 입력하여 함수 검토 및 수정을 요청합니다.
```md copy
