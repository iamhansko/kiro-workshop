...
> - AWS_DEFAULT_REGION : AWS 계정 사용자가 상호작용하는 기본 리전 지정
> - AWS_ACCESS_KEY_ID : AWS 계정 사용자와 연결된 액세스 키 지정
> - AWS_SECRET_ACCESS_KEY : 액세스 키와 연결된 보안 키 지정 ("암호" 역할)
> - AWS_SESSION_TOKEN : 임시 보안 자격 증명에 필요한 세션 토큰 값 지정 ("추가 암호" 역할)
...
환경 설정을 완료하고 게임 서버/클라이언트를 잘 실행했다면, 이제 Spirit of Kiro 게임을 플레이 해보세요. 아래 가이드는 게임의 기본 조작법과 메커니즘을 설명합니다.
